...
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;
public class SearchLabUi extends JFrame implements ActionListener {
    ...
    SearchLabUi()
    {
       ...
       title.setBounds(0,0,1870,200); 
        ...
        title.setText("Search Lab Reports :");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == searcButton)
        {
            ...
            File inFile = new File("C:/Users/USER/Desktop/hospital management/Labinfo.txt");
            ...
            try
            {
               ...
               Scanner input = new Scanner(Read);
                ...
                while(input.hasNext()) // to read the file
                {
                    ...
                    {
                        flag = 1;
                       String Text ="<html>Name : "+s.toUpperCase()+"<br>Age : "+s1.toUpperCase()+"<br>Sex : "+s2.toUpperCase()+"<br>Tests : "+s3.toUpperCase()+"<br>Dates : "+s4.toUpperCase()+"</html>";
                    //    lap.setText(Text);
                ...
                if(flag == 0)
                {
                    labels[2].setText("No Paitent Found 😢");
                }
